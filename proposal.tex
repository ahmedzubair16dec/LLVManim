...
\begin{itemize}
    ...
    \item \textbf{Memory Operation Identification:} Catalog \texttt{load}, \texttt{store}, \texttt{alloca}, and \texttt{call} instructions for tracking memory access and stack operations.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Customization API:} Expose configuration via command-line flags and YAML:
    \begin{itemize}
...
\begin{verbatim}
# Visualize C program
llvmanim factorial.c --mode cfg --output demo.mp4

# Custom speed and colors
llvmanim quicksort.c --mode memory --speed 0.75 
    --palette dark --output sort.mp4

# Interactive mode
llvmanim recursive.c --mode trace --interactive
\end{verbatim}
