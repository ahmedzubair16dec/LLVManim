...
\begin{itemize}
    ...
    \item \textbf{Layout Algorithm:} Apply hierarchical layout to position control-flow graph (CFG) nodes while minimizing edge crossings and maintaining logical flow direction. We use a modified Sugiyama framework with constraints for common patterns like if-else branches and loop back-edges.
